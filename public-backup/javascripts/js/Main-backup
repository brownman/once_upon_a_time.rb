...
//alert(fred.salary);
      ...
      sequencer.add( new Part6Effect( camera, renderer ), keys[ 0 ], keys[ 1 ], 1 );
      sequencer.add( new Part6Effect( camera, renderer ), keys[ 1 ], keys[ 2 ], 1 );
      sequencer.add( new Part6Effect( camera, renderer ), keys[ 2 ], keys[ 3 ], 1 );
//      sequencer.add( new Part6Effect( camera, renderer ), keys[ 3 ], keys[ 4 ], 1 );
//      sequencer.add( new Part6Effect( camera, renderer ), keys[ 4 ], keys[ 5 ], 1 );
//      sequencer.add( new Part6Effect( camera, renderer ), keys[ 5 ], keys[ 6 ], 1 );
//      sequencer.add( new Part6Effect( camera, renderer ), keys[ 6 ], keys[ 7 ], 1 );
//      sequencer.add( new Part6Effect( camera, renderer ), keys[ 7 ], keys[ 8 ], 1 );
...
//  from_ruby = document.getElementById( 'ofer1' );
//console.log(ofer1);
// alert(  "ofer1=" + ofer1);
  ...
  document.body.removeChild( document.getElementById( 'railstuff1' ) );
